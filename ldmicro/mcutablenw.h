...
McuAdcPinInfo AvrAtmega328AdcPinInfo[] = {
    { 23, 0x00 }, // ADC0
    { 24, 0x01 },
    { 25, 0x02 },
    { 26, 0x03 },
...
McuIoInfo SupportedMcus[NUM_SUPPORTED_MCUS] = {
    {
        ...
        64*1024,
        { { 0x100, 4096 } },//SRAM(start address,size)
    ...
    {
        "Atmel AVR ATmega328 28-PDIP 32kFlash",
        'P',
        ...
        AvrAtmega328AdcPinInfo,
        arraylen(AvrAtmega328AdcPinInfo),
        1023,
        { 2, 3 },
        17,
        ISA_AVR,
